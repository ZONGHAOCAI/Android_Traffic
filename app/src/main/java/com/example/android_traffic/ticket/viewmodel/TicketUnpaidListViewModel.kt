...
class TicketUnpaidListViewModel : ViewModel() {
    ...
    private fun loadUnpaidList() {
        ...
        unpaidlist.add(Content("A123","1天"))
        unpaidlist.add(Content("A143","1天"))
        unpaidlist.add(Content("A133","1天"))
        unpaidlist.add(Content("A163","2天"))
        unpaidlist.add(Content("A173","3天"))
        unpaidlist.add(Content("A183","3天"))
        unpaidlist.add(Content("A193","4天"))
        unpaidlist.add(Content("A124","1天"))
        unpaidlist.add(Content("A125","1天"))
        unpaidlist.add(Content("A103","4天"))
        unpaidlist.add(Content("A263","4天"))
        unpaidlist.add(Content("A273","4天"))
        unpaidlist.add(Content("A283","4天"))
        unpaidlist.add(Content("A293","4天"))
        unpaidlist.add(Content("A303","4天"))
